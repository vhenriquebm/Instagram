...
typealias profileCompletion = (User?) -> Void
typealias usersCompletion = (([User]) -> Void)
typealias FirestoreCompletion = (Error?) -> Void
typealias UserStatsCompletion = (UserStats) -> Void
...
extension ProfileService {
    ...
    func getPosts(with uuid: String, completion: @escaping ([PostList]) -> Void) {
    ...
    func getPost(with uuid: String, completion: @escaping (PostList) -> Void) {
